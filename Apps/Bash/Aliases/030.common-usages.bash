...
alias ripit='env ripit --device /dev/sr0 --nosubmission --archive --eject --outputdir ~/CDRip --coder 0 --bitrate 320 --tracktemplate '"'"'"$tracknum - $trackname"'"'"' --dirtemplate '"'"'"$artist/$album"'"'"
